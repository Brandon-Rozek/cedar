...
mod schema_based_parsing_tests {
    ...
    impl Schema for MockSchema {
        ...
        fn entity_types_with_basename<'a>(
            ...
            match basename.as_ref() {
                "Employee" => Box::new(std::iter::once(EntityType::new(Name::unqualified_name(
                    basename.clone(),
                )))),
                "Action" => Box::new(std::iter::once(EntityType::new(Name::unqualified_name(
                    basename.clone(),
                )))),
    ...
    impl EntityTypeDescription for MockEmployeeDescription {
        fn entity_type(&self) -> EntityType {
            EntityType::new(Name::parse_unqualified_name("Employee").expect("valid"))
        }
        ...
        fn attr_type(&self, attr: &str) -> Option<SchemaType> {
            ...
            let hr_ty = || SchemaType::Entity {
                ty: EntityType::new(Name::parse_unqualified_name("HR").expect("valid")),
            };
            match attr {
    ...
    fn namespaces() {
        ...
        impl Schema for MockSchema {
            ...
            fn entity_types_with_basename<'a>(
                ...
                match basename.as_ref() {
                    "Employee" => Box::new(std::iter::once(EntityType::new(
        ...
        impl EntityTypeDescription for MockEmployeeDescription {
            fn entity_type(&self) -> EntityType {
                EntityType::new("XYZCorp::Employee".parse().expect("valid"))
            }
