 ...
 */
 ...
 /// expression.
 #[derive(Debug)]
 pub struct ExprIterator<'a, T: Default + std::clone::Clone = ()> {
 ...
 impl<'a, T: Default + std::clone::Clone> ExprIterator<'a, T> {
 ...
 impl<'a, T: Default + std::clone::Clone> Iterator for ExprIterator<'a, T> {
     type Item = &'a Expr<T>;
